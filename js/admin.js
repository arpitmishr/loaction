            ...
            <div class="invoice-half">
                ...
                <div class="address-section">
                    <div class="addr-box" style="border-right:1px solid #000;">
                        ...
                        <span style="font-size:9px; line-height:1.1; display:block; margin-bottom:2px;">${userSettings.address.substring(0, 65)}</span>
                ...
                <div class="table-container">
                    <table class="inv-table">
                        ...
                        <tbody>
                            ...
                            `).join('')}
                            ${Array(Math.max(0, 5 - userSettings.items.length)).fill(0).map(() => `<tr><td style="color:white">.</td><td></td><td></td><td></td><td></td><td></td><td></td></tr>`).join('')}
                        </tbody>
                    </table>
                </div>
